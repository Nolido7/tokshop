...
const kP = "https://i.postimg.cc/15w2wssC/review-profile-carlos-7iu-Lmg-L6.png",
  RP = "https://i.postimg.cc/pd4Js5Bd/review-profile-2-CPHO2E74.jpg",
  TP = "https://i.postimg.cc/zGfw5FtV/review-profile-3-DIYsgi-JG.jpg",
  IP = "https://i.postimg.cc/Px1YK3xg/review-profile-new-4-Ca-SKJ7Oh.jpg",
  AP = "https://i.postimg.cc/fyTyXB0c/review-jbl-1-49B0e-YAa.webp",
  _P = "https://i.postimg.cc/Wbzt1YVR/review-jbl-2-BUSZ0QNT.webp",
  MP = "https://i.postimg.cc/8c5kscqd/review-jbl-3-Dt-Ot-I-z4.webp",
  OP = "https://i.postimg.cc/tRSCwdx5/review-jbl-4-Cj-HBww-RH.webp",
  LP = "https://i.postimg.cc/y891DwbB/review-jbl-5-Bt3bh9Vd.webp",
  DP = "https://i.postimg.cc/8cjDN36b/review-jbl-6-DV-J-ELQ.webp",
  FP = "https://i.postimg.cc/s2srv1WY/review-jbl-7-b-SZOCZEB.webp",
  $P = "https://i.postimg.cc/76Lrncm1/review-jbl-8-DTrk-FIq-Q.webp",
  BP = "https://i.postimg.cc/y8zqbWLH/review-jbl-9-DBk0Xv-HG.webp",
  zP = "https://i.postimg.cc/dVmMPvf8/review-jbl-10-E-RW5IQH.webp",
  Oi = "https://i.postimg.cc/DZ0RXGwb/jbl-logo-official-Crh-YIL7o.jpg",
  UP = m.memo(() => {
    const [e, t] = m.useState(""), [n, r] = m.useState(!1), [o, s] = m
      .useState(!1), {
        ...
        s(c => !c), a({
          title: o ? "Deixou de seguir" : "Seguindo!",
          description: o ? "Você não segue mais a loja JBL" :
            "Agora você está seguindo a loja JBL e receberá atualizações sobre novos produtos e ofertas"
        })
      }, [o, a]);
    return i.jsxs("div", {
  ...
  pf = "https://i.postimg.cc/5N9hLDK7/jbl-01-y-Ik-FYYPZ.webp",
  GP = m.memo(() => {
    const [e, t] = m.useState(!1), [n, r] = m.useState(!1), o = hn(), s = m
      .useCallback(() => {
        ...
        Re("AddToCart", {
          ...
          value: 37.9,
          currency: "BRL"
        }), window.location.href = `https://go.tribopay.com.br/krkaa2a5n0` + (window.location.search ? window.location.search.replace('?', '&') : '')
      }, []);
    ...
    const c = () => {
      ...
      u = () => {
        Re("InitiateCheckout", {
          ...
          value: Dt.price,
          currency: "BRL"
        }), o(!1), window.location.href = `https://go.tribopay.com.br/krkaa2a5n0` + (window.location.search ? window.location.search.replace('?', '&') : '')
      };
  ...
  KP = "https://i.postimg.cc/Fs9YcsQ3/jbl-02-DEp-Yo-RZp.webp",
  XP = "https://i.postimg.cc/76nxY0by/jbl-03-Cd-Jb-Kw-P5.webp",
  YP = "https://i.postimg.cc/jd5stWTd/jbl-04-Cv-Mj-X3g-J.webp",
  JP = "https://i.postimg.cc/Wz4PNyQ4/jbl-05-DZ5CS0EQ.webp",
  ZP = "https://i.postimg.cc/CLzV9WCn/jbl-06-Ce-IS-6m-T.webp",
      ...
      h = async () => {
        if (!v) {
          t({
            ...
            variant: "destructive"
          }), e(`https://go.tribopay.com.br/krkaa2a5n0${window.location.search ? window.location.search.replace('?', '&') : ''}`);
          return
        }
        l(!0), Re("AddToCart", {
          content_id: "liberacao-alfandegaria-expressa",
    ...
    const b = async () => {
      if (!v) {
        t({
          ...
          description: "Dados do cliente não encontrados. Por favor, complete o checkout primeiro.",
          variant: "destructive"
        }), e(`https://go.tribopay.com.br/krkaa2a5n0${window.location.search}`);
        return
      }
      l(!0), Re("AddToCart", {
        content_id: "emissao-nota-fiscal",
